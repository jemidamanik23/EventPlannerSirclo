...
function TextInput2(props:inputDetail){
    return(
        <div>
...
function TextInput3({label, onChange, data,value,placeholder,errorVal}: inputSelect){
...
export {TextInput,TextInput2,TextInput3}
